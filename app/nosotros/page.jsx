  ...
  return (
    <div className="w-full font-[Montserrat] bg-white text-gray-900">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.7 }}
        className="py-24 px-6 md:px-8 bg-gradient-to-br from-gray-50 to-white"
      >
        <div className="max-w-7xl mx-auto">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
        className="py-24 px-6 md:px-8 bg-gradient-to-tr from-gray-50 to-white"
      >
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
            ...
            <div className="bg-yellow-500/5 rounded-2xl p-8 border-l-4 border-yellow-500">
              <p className="text-gray-700 text-lg leading-relaxed text-center max-w-4xl mx-auto">
                M&M Contratistas Generales inició actividades en <strong className="text-gray-900">2016</strong> 
                brindando soluciones de construcción y remodelación. Hoy hemos ampliado nuestro equipo, 
                infraestructura y alcance, convirtiéndonos en una opción sólida y profesional en el mercado peruano.
              </p>
            </div>
