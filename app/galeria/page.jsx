...
export default function GaleriaServicios() {
  ...
  return (
    <div className="w-full font-[Montserrat] bg-white text-gray-900">
      ...
      <section className="py-20 text-center px-6 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto">
            ...
            mantenimiento y remodelaciones con los más altos estándares de calidad.
          </p>
        </div>
      </section>

      {/* BARRA DE BÚSQUEDA Y FILTROS */}
      <section className="relative mb-16 bg-white py-8">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {categories.map((cat) => (
              <button
                ...
                className={`
                  px-6 py-3 text-sm font-bold uppercase transition-all duration-300 rounded-xl
                  border-2 flex items-center gap-2 min-w-[120px] justify-center
                  ${filter === cat
          ...
          <div className="w-full h-1 bg-gradient-to-r from-transparent via-yellow-500 to-transparent mt-8 mx-auto max-w-4xl"></div>
        </div>
      </section>
              ...
              >
                ...
                <div className="relative h-80 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent 
                    ...
                    <h3 className="text-white text-xl font-extrabold uppercase mb-2">
                      {item.title}
                    </h3>
                ...
                <div className="p-5 bg-white">
                  <h3 className="text-lg font-bold text-gray-800 uppercase mb-1">
                    {item.title}
                  </h3>
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
          <div className="relative max-w-6xl max-h-[90vh] w-full">
            ...
            <div className="bg-white rounded-b-2xl p-6">
              ...
              <h3 className="text-2xl font-extrabold uppercase text-gray-800 mb-2">
                {selectedImage.title}
              </h3>
              <p className="text-gray-600">
                Servicio profesional realizado con los más altos estándares de calidad
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="text-center pb-20 bg-gradient-to-t from-white to-gray-50">
        <a
          href="/servicios"
          className="bg-yellow-500 hover:bg-yellow-600 text-black px-10 py-4 font-extrabold uppercase tracking-wider 
                     rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl
        ...
        <p className="text-gray-500 mt-6 text-sm max-w-md mx-auto">
          Descubre nuestra completa gama de servicios profesionales para construcción y mantenimiento
        </p>
      </div>
    </div>
  );
