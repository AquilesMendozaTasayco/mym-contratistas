...
export default function Servicios() {
  ...
  return (
    <div className="w-full font-[Montserrat] bg-white text-gray-900">
      ...
      {/* INTRO MEJORADA */}
      <section className="py-20 px-6 md:px-8 text-center bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="max-w-3xl mx-auto text-gray-600 text-lg leading-relaxed">
            ...
            y mantenimiento especializado, con altos estándares de calidad y 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 max-w-4xl mx-auto">
            {beneficios.map((beneficio, index) => (
              <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-xl shadow-lg border border-gray-100">
                <div className="bg-yellow-500/10 p-2 rounded-lg">
                  {beneficio.icon}
                </div>
                <span className="text-sm font-semibold text-gray-700 text-left">{beneficio.text}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 md:px-8 pb-28 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          {/* LLAMADO A LA ACCIÓN */}
          <div className="text-center mt-16 p-8 bg-gradient-to-r from-yellow-500/10 to-yellow-500/5 rounded-3xl border border-yellow-500/20">
            <h3 className="text-2xl md:text-3xl font-bold uppercase mb-4 text-gray-800">
              ¿No encuentras lo que buscas?
            </h3>
            <p className="text-gray-600 text-lg mb-6 max-w-2xl mx-auto">
              Contáctanos para una consulta personalizada. Estamos aquí para ayudarte 
              con cualquier proyecto de construcción o mantenimiento.
            </p>
